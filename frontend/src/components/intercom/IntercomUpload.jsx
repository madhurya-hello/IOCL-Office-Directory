...
const IntercomUpload = ({ onClose }) => {
  ...
  const MAX_FILE_SIZE = 120 * 1024; // 120KB file size limit
  ...
  const handleFileUpload = (selected) => {
    if (files.length > 0) {
      toast.warning("Note: Only one file can be uploaded at a time");
      return;
    }
    ...
    if (oversizedFiles.length > 0) {
      toast.warning("File must be under 120KB");
      return;
    }
    ...
    >
      <motion.div
        ...
        style={{
          ...
          padding: "3rem",
          position: "relative",
          boxShadow: "0 10px 25px rgba(0, 0, 0, 0.36)",
          display: "flex",
      ...
      >
        ...
        {/* Warning section with template download */}
        <div
          style={{
        ...
        >
          ...
          >
            <a
              href="/assets/IntercomUploadTemplate.xlsx"
